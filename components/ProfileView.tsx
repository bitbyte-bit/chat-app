  ...
  return (
    <div className="flex flex-col h-full bg-[#0b141a] animate-in slide-in-from-right duration-300 overflow-hidden">
      <header className={`h-[60px] md:h-[110px] bg-[#202c33] flex items-end px-4 pb-4 md:pb-6 gap-6 shrink-0 ${isMobile ? 'safe-top h-[120px] pt-10 pb-6' : ''}`}>
        ...
        <h2 className="text-[#e9edef] text-2xl font-bold font-outfit">Profile</h2>
      </header>
          ...
          <div className="space-y-10 bg-[#111b21] p-8 rounded-[48px] border border-white/5 shadow-2xl">
            <div className="space-y-3">
              ...
              <input 
                ...
                className="w-full bg-[#202c33] border border-white/5 rounded-2xl px-5 py-4 text-[#d1d7db] font-medium focus:border-[#00a884]/50 outline-none transition-all shadow-inner"
              />
            ...
            <div className="space-y-3">
              ...
              <textarea 
                ...
                className="w-full bg-[#202c33] border border-white/5 rounded-2xl px-5 py-4 text-[#d1d7db] font-medium focus:border-[#00a884]/50 outline-none transition-all resize-none shadow-inner"
                rows={3}
              />
            </div>
          </div>
