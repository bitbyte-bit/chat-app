...
export const generateResponse = async (
  ...
  // Extract and append Google Search grounding chunks if available (required by guidelines)
...
export const generateImage = async (prompt: string): Promise<string> => {
  ...
  for (const part of parts) {
    // Correctly find the image part by checking for inlineData (as per guidelines)
    if (part.inlineData) {
